<%@page import="in.com.college.dto.StudentDTO"%>
...
<%@page import="in.com.college.controller.StudentListCtl"%>
...
.p4{
background-image: url('<%=ORSView.APP_CONTEXT%>/img/stl.png');
	background-size: 100%;
...
<body class="p4">
	<div>
		<form action="<%=ORSView.STUDENT_LIST_CTL%>" method="post">
			...
			<jsp:useBean id="dto" class="in.com.college.dto.StudentDTO"
