...
<body>
	...
	<div class="header">
		...
		<nav class="navbar navbar-expand-lg reg fixed-top"> <a
			...
			src="<%=ORSView.APP_CONTEXT%>/img/logologo.png" width="190px"
			height="50px"></a>
				...
				%><li class="nav-item dropdown"
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item"
							...
							href="<%=ORSView.MY_PROFILE_CTL%>"><i class="fa fa-graduation-cap"></i>My
							Profile</a> </i> </a>
						<%
							} else {
						%>
						<a class="dropdown-item" href="<%=ORSView.LOGIN_CTL%>"><i
							...
							class="dropdown-item" href="<%=ORSView.USER_REGISTRATION_CTL%>"><i
								class="fa fa-user-plus"><b> User Registration</b></i></a>
					</div></li>
				<%
					}
				%>
