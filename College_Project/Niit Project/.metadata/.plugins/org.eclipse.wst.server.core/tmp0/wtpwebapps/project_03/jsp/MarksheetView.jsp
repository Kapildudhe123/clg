<%@page import="in.com.college.controller.MarksheetCtl"%>
<%@page import="in.com.college.util.HTMLUtility"%>
<%@page import="java.util.List"%>
<%@page import="in.com.college.util.DataUtility"%>
<%@page import="in.com.college.util.ServletUtility"%>
...
.grad {
	background-image: linear-gradient(to bottom right, green, red, pink, green);
...
<body class="hm">
	<jsp:useBean id="dto" class="in.com.college.dto.MarksheetDTO"
